//! Test environment for Faucet pallet.
...
pub type AccountStore = <Test as pallet_balances::Config>::AccountStore;
...
parameter_types! {
	pub const FaucetDripAmount: u64 = 10;
	pub const MinBlocksBetweenClaims: u64 = 2;
